...
function fetchCountryData() {
  ...
  // Create Bootstrap card with country data
  function createCountryCard(countryData) {
    ...
    weatherButton.textContent = 'Weather Updates';
  ...
  // Display country cards on the screen
  ...
  // Fetch country data and display country cards
  fetchCountryData()
    .then(countryData => {
    ...
    .then(weatherData => {
      // Update the country cards with weather information
